...
//  Za Hunter
//
//  Created by daniell Escareno on 2/19/26.
//
...
struct LocationDetailsView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Button(action: {
                let lantitude = mapItem.placemark.coordinate.latitude
                let longtitude = mapItem.placemark.coordinate.longitude
                let url = URL(string: "http://maps.apple.com/?q=\(lantitude),\(longtitude)")!
